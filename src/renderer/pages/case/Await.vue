        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    ...
                    <el-button @click="delCase(scope.row.caseId)" type="text" size="small">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--<el-pagination-->
...
<script>
	import {fetchDelCase} from '../../common/api/index'
	...
	export default {
		...
		methods: {
			...
			async delCase(caseId) {
				const delCaseRes = await fetchDelCase({caseId})
				await this.getCaseList(0)
			}
		},
	}
